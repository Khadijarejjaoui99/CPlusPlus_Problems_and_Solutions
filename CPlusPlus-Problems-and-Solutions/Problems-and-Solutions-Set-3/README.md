...
Write a program to fill a 3x3 matrix with random numbers from 1 to 100. Then sum each row and store the result in an array.
<br><br> <img src = "problem02/problem2.png" alt = "problem 2 output example">
...
Write a program to fill a 3x3 matrix with random numbers from 1 to 100. Then sum each Column and store the result in an array.
<br><br> <img src = "problem04/problem4.png" alt = "problem 4 output example">
